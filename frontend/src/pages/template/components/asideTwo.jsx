          ...
          <li className="flex space-y-3 space-x-3 ">
            ...
            <div className="flex flex-col justify-between  ">
              <div className="flex flex-col space-y-1">
                <span className="text-gray-700 dark:text-white font-semibold">The Shawshank
                            Redemption</span>
      ...
      <div className="mt-10">
        ...
        <ul className="mt-4 text-gray-400 text-xs space-y-3">
          ...
          <li className="flex space-x-3 ">
            ...
            <div className="flex flex-col justify-between  ">
              <div className="flex flex-col space-y-1">
                <span className="text-gray-700 dark:text-white font-semibold">The Silence of the
                            Lambs</span>
